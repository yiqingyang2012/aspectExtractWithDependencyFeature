...
def output_features(fo, X, field='', field2=''):
    """
...
-t option (CRFsuite Python module must be installed)."""
    ...
    parser.add_option(
        '-i', dest='inputfile', default="train.txt",
        help='specify the separator of columns of input data [default: "%default"]'
        )

    parser.add_option(
        '-o', dest='outputfile', default="output.txt",
        help='specify the separator of columns of input data [default: "%default"]'
        )
